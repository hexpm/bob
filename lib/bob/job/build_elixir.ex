defmodule Bob.Job.BuildElixir do
  ...
  def elixir_to_otp(ref) do
    case ref do
      ...
      "v1.1" -> ["17.5", "18.3"]
      "v1.2.0-" <> _ -> ["18.3"]
      "v1.2." <> patch when patch in ~w(0 1 2 3 4 5 6) -> ["18.3"]
      "v1.2." <> _ -> ["18.3", "19.3"]
      "v1.2" -> ["18.3", "19.3"]
      "v1.3" <> _ -> ["18.3", "19.3"]
      "v1.4.0-" <> _ -> ["18.3", "19.3"]
      "v1.4." <> patch when patch in ~w(0 1 2 3 4) -> ["18.3", "19.3"]
      "v1.4." <> _ -> ["18.3", "19.3", "20.3"]
      "v1.4" <> _ -> ["18.3", "19.3", "20.3"]
      "v1.5." <> _ -> ["18.3", "19.3", "20.3"]
      "v1.5" <> _ -> ["18.3", "19.3", "20.3"]
      "v1.6.0-" <> _ -> ["19.3", "20.3"]
      "v1.6." <> patch when patch in ~w(0 1 2 3 4 5) -> ["19.3", "20.3"]
      ...
      "v1.9" -> ["20.3", "21.3", "22.3"]
      "v1.10.0-" <> _ -> ["21.3", "22.3"]
      "v1.10." <> patch when patch in ~w(0 1 2) -> ["21.3", "22.3"]
